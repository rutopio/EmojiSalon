...
function ButtonGroup({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: ButtonGroup intentionally uses role="group" on a div for consistent cross-browser styling; <fieldset> carries default UA styles that break the layout.
    <div
      role="group"
